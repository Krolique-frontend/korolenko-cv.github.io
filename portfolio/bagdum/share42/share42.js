...
window.addEventListener('load', function() {
  ...
  for (var k = 0; k < e.length; k++) {
    if (e[k].className.indexOf('share42init') != -1) {
      ...
      var s = new Array('"//www.evernote.com/clip.action?url=' + u + '&title=' + t + '" title="Добавить в Evernote"', '"#" data-count="fb" onclick="window.open(\'//www.facebook.com/sharer/sharer.php?u=' + u + '\', \'_blank\', \'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0\');return false" title="Поделиться в Facebook"', '"#" data-count="twi" onclick="window.open(\'//twitter.com/intent/tweet?text=' + t + '&url=' + u + '\', \'_blank\', \'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0\');return false" title="Добавить в Twitter"', '"#" data-count="lnkd" onclick="window.open(\'//www.linkedin.com/shareArticle?mini=true&url=' + u + '&title=' + t + '\', \'_blank\', \'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=600, height=400, toolbar=0, status=0\');return false" title="Добавить в Linkedin"', '"//www.juick.com/post?body=' + t + ' - ' + u + '" title="Добавить в Juick"', '"//www.stumbleupon.com/submit?url=' + u + '&title=' + t + '" title="Добавить в StumbleUpon"');
      var l = '';
